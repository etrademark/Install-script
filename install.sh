...
dotfiles="swaync rofi-wayland wofi bc hyprpolkitagent wl-clipboard thunar blueman networkmanager ttf-jetbrains-mono-nerd ttf-font-awesome network-manager-applet pavucontrol alsa-firmware cava waybar swww"
